...
const benefits = [
  ...
  },
  {
    ...
    desc: "Customers trust businesses with a website 5× more. No website = no trust. A premium design makes you look established, serious, and professional.",
    stat: "5×",
...
const drawbacks = [
  ...
  },
  {
    ...
    stat: "₹50K+",
    statLabel: "lost per year on average",
    color: "#ff5f57",
  },
  {
    icon: AlertTriangle,
          ...
          >
            ...
            <div className="flex items-start justify-between mb-5">
              ...
              <div className="text-right">
                <div className="text-3xl font-black" style={{ color: item.color, fontFamily: "'Barlow Condensed',sans-serif" }}>
                  {item.stat}
                </div>
                <div className="text-xs text-gray-500 max-w-[130px] text-right leading-tight">{item.statLabel}</div>
              </div>
            </div>
